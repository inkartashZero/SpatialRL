...
from experiments.stepwise_Telemetry import TelemetryLogger
...
DEFAULT_CONFIGS = {
    ...
    "ppo": dict(
        ...
        rollout_steps=50, batch_size=64, device="auto",
    ),
    "a2c": dict(
        hidden_size=256, 
        lr=3e-4, 
...
def _parse():
    ...
    # p.add_argument("--poke_penalty",   type=float, default=-0.01)
...
if __name__ == "__main__":
    ...
    run_continuous_experiment(
        ...
        # poke_penalty  = args.poke_penalty,
    )